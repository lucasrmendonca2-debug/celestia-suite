        ...
        <main className="mx-auto max-w-5xl px-6 py-8">
          <section className="rounded-2xl border border-border bg-card p-6">
            <div className="flex items-center gap-4">
              {guild.iconUrl ? (
                <img src={guild.iconUrl} alt="" className="size-16 rounded-2xl ring-1 ring-border" />
              ) : (
          ...
          <section className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <StatCard icon={<Users className="size-4" />} label="Plano" value="Padrão" hint="Premium em breve" />
          ...
          <section className="mt-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <ModuleCard to="/dashboard/$guildId/tickets" params={{ guildId: guild.id }} icon={Ticket} title="Tickets" description="Sistema completo de atendimento com painel único e logs." />
