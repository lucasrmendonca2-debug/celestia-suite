...
import { reportError, installGlobalErrorReporter } from "../lib/dev-logs/client";
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    ...
    reportError(error, { source: "boundary", metadata: { boundary: "tanstack_root_error_component" } });
  }, [error]);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
