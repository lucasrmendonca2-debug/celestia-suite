...
export function DashboardTopbar({
  ...
  return (
    <header className="sticky top-0 z-20 grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 border-b-2 border-[#1B0E3B] bg-white/85 px-4 py-3 backdrop-blur-md sm:px-6">
