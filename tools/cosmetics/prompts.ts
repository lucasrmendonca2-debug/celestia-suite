...
export const BANNERS: CosmeticPrompt[] = [
  ...
  // Mascote Zenox: menino jovem (~10-14 anos visual), cabelo PRETO BAGUNÇADO
  // com franja farta, pele MORENA / light brown, olhos castanhos grandes e
  // expressivos, moletom/hoodie ESCURO (preto ou cinza grafite). Óculos
  // quadrados pretos são OPCIONAIS — podem estar no rosto, na cabeça, na mão,
  // pendurados no colarinho, ou nem aparecer. Personalidade: travesso,
  // engraçado, expressivo, natural (não pose rígida de mascote). Pode aparecer
  // em qualquer estilo de arte, qualquer proporção (chibi, realista, anime,
  // sumi-ê, pixel art) — o que importa é a IDENTIDADE: cabelo preto bagunçado
  // + pele morena + moletom escuro + vibe expressiva.
  ...(() => {
    const CHAR =
      "the Zenox mascot character: a young boy with messy black hair and thick bangs, light brown / tan skin, big expressive brown eyes, wearing a dark hoodie (black or graphite). Square black sunglasses are OPTIONAL — they can be on his face, pushed up on his head, hanging from the collar, held in one hand, or completely absent. Personality is mischievous, expressive, natural, full of life — never a stiff mascot pose";
    const BASE =
      "ultra wide cinematic profile banner, no text, no watermark, no logo, balanced horizontal composition, character placed off-center leaving negative space on one side for avatar and name overlay, intact anatomy, professional illustration, aspect ratio 3:1";
    ...
    return [
      c("banner-zenox-sumie-cerejeira", "Tinta e Cerejeira", "Zenox meditando sob cerejeira em sumi-ê", "epic",
        "traditional Japanese sumi-e ink painting on aged washi paper, loose expressive black brush strokes with sparse pink cherry blossom petals carried by wind, the character sitting cross-legged under a sakura branch holding a calligraphy brush mid-stroke, eyes calmly closed, NO sunglasses visible, single red hanko seal in a corner, vast empty paper space"),
      c("banner-zenox-sumie-koi", "Lago dos Carpas", "Zenox brincando com carpas em sumi-ê", "rare",
        "minimalist sumi-e ink wash on cream paper, two koi carp swirling in suggested water, the character leaning over the pond from one side with a wide surprised laugh, one hand reaching toward the fish, hair flowing, ink splashes, no sunglasses, asymmetric composition with massive negative space"),
      c("banner-zenox-anime-shounen-run", "Corrida do Herói", "Zenox correndo em estilo shounen dinâmico", "rare",
        "vibrant 90s shounen anime cel-shaded style with bold black outlines and motion lines, the character sprinting full speed toward the viewer through a sunset cityscape, hoodie sleeves flapping, mouth open in a fierce determined yell, sunglasses pushed up on his forehead, dynamic low angle, speed streaks"),
      c("banner-zenox-anime-cosplay-fma", "Alquimista de Aço", "Zenox em cosplay de Edward Elric com automail e transmutação", "legendary",
        "Fullmetal Alchemist Brotherhood anime style with crisp linework and rich shading, the character cosplaying Edward Elric: long red hooded coat with the flamel symbol on the back, black leather jacket and pants underneath, white gloves, polished steel automail right arm, hands clapped together mid-transmutation with crackling blue alchemy lightning between his palms and a glowing transmutation circle on the ground at his feet, determined cocky smirk, hair tied back roughly, no sunglasses, industrial Amestris alley with warm sunset light"),
      c("banner-zenox-anime-cosplay-kimono", "Caçador de Kimono", "Zenox cosplay caçador em floresta de bambu", "epic",
        "Demon Slayer inspired anime style with crisp linework and watercolor shading, the character wearing a black-and-green checkered haori over a dark uniform, gripping a katana with a violet gradient blade lowered at his side, standing calmly in a moonlit snowy bamboo forest, breath visible in cold air, sunglasses hooked on his collar, serious focused half-smile"),
      c("banner-zenox-cyberpunk-neon", "Beco Neon", "Zenox em beco de Tokyo cyberpunk chuvoso", "epic",
        "cyberpunk anime cinematic style heavy on neon reflections and rain, the character standing in a rainy Tokyo back alley flooded with pink and cyan holographic signage, oversized translucent tech hoodie with glowing seams, one hand in pocket the other holding up the square sunglasses to peek over them with a smug smirk, neon glow on his cheek, atmospheric haze and bokeh"),
      c("banner-zenox-ghibli-window", "Sonho de Verão", "Zenox olhando pela janela em estilo Ghibli", "rare",
      ...
      // ---- Batch 3: darker anime / cinematic fantasy ----------------------
      c("banner-zenox-shinobi-redmoon", "Lua Carmesim", "Zenox shinobi sob lua vermelha gigante", "legendary",
        "dark cinematic shinobi anime style, the character standing sideways on a torii gate under a huge blood-red moon, black scarf whipping in the wind, hand near a sheathed short sword, calm dangerous smirk, crimson maple leaves flying through the night sky"),
      c("banner-zenox-blueflame-exorcist", "Chamas Azuis", "Zenox com katana envolta em fogo azul", "legendary",
        "high-energy anime exorcist style, the character unsheathing a katana wrapped in vivid blue flames, black school jacket over the hoodie, rooftop at night with city lights below, confident grin, blue fire trails and sparks across the sky"),
      c("banner-zenox-touge-racer", "Drift da Montanha", "Zenox corredor noturno em estrada molhada", "epic",
        "stylish anime street-racing scene at a mountain pass at night, the character leaning against a sleek black tuner car with cyan underglow, square sunglasses on face, smug smile, wet asphalt reflections and motion-blurred taillights"),
      c("banner-zenox-ice-mage", "Mago do Gelo", "Zenox conjurando gelo sob aurora boreal", "legendary",
        "fantasy anime illustration, the character conjuring crystalline ice shards and snow spirals from one raised hand, pale cyan glow on his face, frozen lake and aurora in the background, serene focused expression"),
      c("banner-zenox-cardmaster", "Mestre das Cartas", "Zenox ilusionista cercado por cartas douradas", "epic",
        "stylish anime illusionist scene, the character flicking glowing tarot-like cards into the air with one hand, black coat over hoodie, sly smile, dramatic gold and teal lighting, swirling magical ribbons and luxurious casino-fantasy atmosphere"),
      c("banner-zenox-sky-whale", "Baleia Celeste", "Zenox observando uma baleia luminosa nos céus", "epic",
        "dreamy anime fantasy banner, the character seated on the edge of a floating rooftop watching a giant luminous sky-whale glide through sunset clouds, soft golden and turquoise palette, peaceful smile, painterly cel-shaded atmosphere"),
      c("banner-zenox-demon-prince", "Príncipe Sombrio", "Zenox sentado em trono de obsidiana", "legendary",
        "dark fantasy anime banner, the character seated casually on a broken obsidian throne with a tiny crooked crown, red ember particles, half-smirk, black and crimson dramatic lighting, smoky ruined hall with shadowy eyes in the darkness"),
      c("banner-zenox-samurai-rain", "Samurai da Chuva", "Zenox samurai em ponte iluminada por lanternas", "epic",
        "elegant anime samurai scene in heavy rain, the character wearing a dark haori over the hoodie, hand resting on katana hilt, standing beneath warm paper lantern glow on an old wooden bridge, moody cinematic blues and ambers"),

      // ---- Batch 4: cosmic, ghibli, fantasy, lifestyle --------------------
      c("banner-zenox-astral-gamer", "Gamer Astral", "Zenox flutuando no cosmos com controle holográfico", "legendary",
        "cosmic anime illustration, the character floating cross-legged in deep space surrounded by constellations and nebulas, holding a glowing holographic controller, neon trails of starlight wrapping around him, vibrant purple cyan and pink palette"),
      c("banner-zenox-sunset-pilot", "Piloto do Crepúsculo", "Zenox no asa de um avião ao pôr do sol", "epic",
        "Studio Ghibli inspired painterly style, the character standing on the wing of a vintage propeller plane mid-flight, scarf flowing in the wind, golden hour sky with warm orange pink and lavender clouds"),
      c("banner-zenox-sea-captain", "Capitão dos Mares", "Zenox capitão em proa de navio sob raios de sol", "epic",
        "painterly adventure illustration, the character as a sea captain at the bow of an old wooden ship cutting through stormy turquoise waves, holding a brass telescope, seagulls overhead, dramatic clouds with godrays, rich blue and gold palette"),
      c("banner-zenox-chaos-alchemist", "Alquimista do Caos", "Zenox conjurando círculo mágico verde e violeta", "legendary",
        "dark fantasy anime style, the character as a chaos alchemist mid-ritual with a massive glowing magic circle of arcane symbols floating before him, energy crackling between his hands, swirling green and violet smoke, ancient laboratory background"),
      c("banner-zenox-steampunk-inventor", "Inventor Steampunk", "Zenox no laboratório com engrenagens e tesla", "rare",
        "warm amber lit painterly illustration, the character as a steampunk inventor in a cluttered workshop full of brass gears copper pipes blueprints and a glowing tesla coil, goggles on forehead, intricate detail"),
      c("banner-zenox-demonslayer", "Respiração das Águas", "Zenox como espadachim em estilo demon slayer", "legendary",
        "Ufotable inspired Demon Slayer anime style, the character as a swordsman with katana drawn, dark haori flowing, cherry blossom petals swirling, moonlit night, swirling water breath dragon effect around the blade"),
      c("banner-zenox-wizard-student", "Aprendiz de Feitiços", "Zenox estudante bruxo em biblioteca encantada", "epic",
        "painterly fantasy illustration, the character as a Hogwarts style wizard student casting a glowing spell from his wand, magical sparks and runes around him, ancient library with floating books and candles, warm magical lighting"),
      c("banner-zenox-ukiyoe-koi", "Carpa Ukiyo-e", "Zenox cavalgando carpa gigante em estilo ukiyo-e", "epic",
        "traditional Japanese ukiyo-e woodblock print style, the character lounging on a giant koi fish floating through clouds, flat colors bold outlines Hokusai-style waves and clouds, rich indigo and red palette"),
      c("banner-zenox-aurora-explorer", "Explorador Polar", "Zenox com husky sob aurora boreal", "epic",
        "painterly illustration, the character as a polar explorer on an icy tundra beside a husky, aurora borealis swirling green and purple across a starry sky, snowy mountains, cool palette"),
      c("banner-zenox-tokyo-night", "Fotógrafo Noturno", "Zenox em Shibuya neon chuvosa com câmera", "rare",
        "cinematic neon photo-illustration, the character as a Tokyo street photographer at night walking through Shibuya with a vintage camera, glowing abstract neon signs reflecting in puddles, rain falling, umbrella in hand, pink blue and yellow neon palette"),
      c("banner-zenox-lofi-barista", "Barista Lo-Fi", "Zenox cafeteria aconchegante em tarde chuvosa", "common",
        "cozy lofi illustration style, the character as a coffee shop barista on a rainy afternoon pouring latte art, steam rising, plants and warm fairy lights around a wooden counter, rain droplets on the window, soft warm palette"),
      c("banner-zenox-dragon-rider", "Cavaleiro do Dragão", "Zenox montando dragão oriental em tempestade", "legendary",
        "epic fantasy anime illustration, the character as a dragon rider on the back of a massive serpentine eastern dragon weaving through stormy clouds, lightning crackling, wind blowing his hair and scarf, dramatic cinematic lighting, blue and gold palette"),
    ];
  })(),
];
